...
(function () {
	...
	$(function () {
		...
		if (plugins.videoOverlay.length && !isNoviBuilder) {
		...
		// Custom waypoints
		if (plugins.scrollTo.length && !isNoviBuilder) {
			plugins.scrollTo.each(function () {
				var o = $(this);
				o.on("click", function (n) {
					n.preventDefault(), $("body, html").stop().animate({scrollTop: $(o.attr("data-waypoint-to")).offset().top}, 800)
				})
			})
		}
